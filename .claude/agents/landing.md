---
name: landing-dev
description: Use this agent for anything inside @src/ — the documentation landing page. Do NOT use for the component library source itself.
---

# Rules for Feature-Sliced Design (FSD)

## Strict rules
- NEVER edit source files in `lib/` — only import from it
