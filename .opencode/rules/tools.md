...
**Source**: `packages/muir/src/shared/smart-clsx.ts`
...
- The `#shared` import alias resolves to `packages/muir/src/shared/` (via rspack/rslib alias in `rslib.config.ts`)
...
**Source**: `packages/muir/src/shared/attributify.ts`
...
- Inside the library, import `atr` from relative paths (`../../shared/attributify` or `../../shared`)
