---
description: General documentation structure for instruments (functions, utilities, hooks)
globs:
...
Paths are relative to the package root (`packages/base/` for the library).
...
- Import paths must match what consumers actually use (e.g., `import { Switch } from '@muir/base'`)
