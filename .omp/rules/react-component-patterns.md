---
description: FSD segment structure, function declarations, prop patterns, CSS modules customization, animation isolation, and React 19 ref forwarding for muir components
globs:
  - "packages/base/src/components/**/*.tsx"
  - "packages/base/src/components/**/*.ts"
  - "packages/base/src/shared/**"
  - "packages/extra/src/components/**/*.tsx"
  - "packages/form/src/components/**/*.tsx"
---
...
Read more about `attributify` usage in rule://styling-tools
...
```ts
// Within @muir/base library — relative imports
...
### Inside `packages/base/src/` (the @muir/base library)

Use **`src/` aliases for cross-slice imports**, relative paths for within-slice imports.
...
import { atr } from '@muir/base/shared'
```

### Inside `packages/capacitor/src/` (the wrapper)

Use **package name imports** from the scoped packages.
...
// ✅ Correct
import { Switch } from '@muir/capacitor'
import { Form, FormCheckbox } from '@muir/capacitor'

// ❌ Forbidden — never import from @muir/base directly in docs
